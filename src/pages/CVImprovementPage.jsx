...
export default function CVImprovementPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      <SectionHeader eyebrow="CV improvement" title="Current User AI-guided CV review">The upload and analysis flow is mocked, but the recommendations reflect the type of feedback a real AI service would generate.</SectionHeader>
      <section className="grid gap-6 xl:grid-cols-[0.9fr_1.1fr]">
        <div className="rounded-lg border border-dashed border-brand-200 bg-white p-8 text-center shadow-sm">
          ...
          <h3 className="mt-5 text-lg font-semibold text-slate-950">Upload Current User CV</h3>
      ...
      <section className="grid gap-6 lg:grid-cols-2">
        ...
        <div className="rounded-lg border border-mint-500/20 bg-white p-6 shadow-sm">
          ...
          <p className="mt-4 rounded-lg bg-mint-50 p-4 text-sm leading-7 text-slate-700">Current User completed a market segmentation project for a simulated consumer brand, identifying three priority customer segments and translating insights into positioning, channel, and pricing recommendations.</p>
        </div>
      </section>
