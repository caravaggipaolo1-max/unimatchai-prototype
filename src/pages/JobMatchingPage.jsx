  ...
  return (
    <div>
      ...
      <SectionHeader
        ...
        title="Current User AI-ranked opportunities"
      ...
      >
        Explore Current User matched offers with personal match percentages and personal rank labels only. Other candidate rankings remain hidden in the student view.
      </SectionHeader>
      <div className="mb-6 grid gap-3 surface-card p-4 md:grid-cols-[1fr_220px]">
