...
export default function MockInterviewPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      <SectionHeader eyebrow="Mock interview" title="Mario Rossi practice with simulated AI feedback">Select an interview track and review generated questions, scoring, and improvement tips.</SectionHeader>
      ...
      <section className="grid gap-6 xl:grid-cols-[1.1fr_0.9fr]">
        <div className="rounded-lg border border-slate-200 bg-white p-6 shadow-sm">
          ...
          <button className="focus-ring mt-5 inline-flex items-center gap-2 rounded-lg bg-slate-950 px-4 py-2 text-sm font-semibold text-white hover:bg-slate-800"><Mic size={16} /> Start mock recording</button>
        </div>
        <div className="space-y-6">
          <div className="rounded-lg border border-slate-200 bg-white p-6 shadow-sm">
            <div className="flex items-center justify-between">
              <h3 className="text-lg font-semibold text-slate-950">Mario Rossi mock feedback</h3>
            ...
            <div className="mt-5 space-y-4">
              ...
              <ProgressBar value={73} label="Business clarity" tone="amber" />
            </div>
          </div>
          <div className="rounded-lg border border-slate-200 bg-white p-6 shadow-sm">
